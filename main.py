...
tk.Label(root, text="Packet Sniffer", font="Helvetica 15 bold").pack()
tk.Label(root, text="Enter IP Subdomain", font="Helvetica 15 bold").pack()
...
tk.Button(button_frame, text='Start Sniffing', command=start_button, width=16, font="Helvetica 16 bold").pack(side=tk.LEFT)
tk.Button(button_frame, text='Stop Sniffing', command=stop_button, width=16, font="Helvetica 16 bold").pack(side=tk.LEFT)
